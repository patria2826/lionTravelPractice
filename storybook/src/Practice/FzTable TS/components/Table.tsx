...
const Table = function (props: any) {
    ...
    let tripStart = tripData ? tripData['data'].map((ele: any, i: number) => {
    ...
    let tripEnd = tripData ? tripData['data'].map((ele: any, i: number) => {
    ...
    let columnData = tripData ? tripData['data'].map((ele: any, i: number) => {
...
Table.defaultProps = {
    ...
    speed: 0.3,
    whenClick: (element: any) => { console.log(element) }
}
